            ...
            <section class="bg-white rounded-xl shadow-lg p-8 border border-blue-100 animate-fadeIn">
                ...
                <form id="complaintForm" action="{{ route('pengaduan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_lengkap" name="nama_lengkap" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="text" id="nik" name="nik" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="16 digit nomor NIK">
                    ...
                    <div>
                        ...
                        <input type="tel" id="telepon" name="telepon" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select id="kategori" name="kategori" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <textarea id="isi_pengaduan" name="isi_pengaduan" rows="5" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></textarea>
                    ...
                    <div>
                        ...
                        <input type="file" id="lampiran" name="lampiran" class="w-full px-4 py-2 border border-gray-300 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                        <div id="lampiran-error" class="text-red-600 text-sm mt-1"></div>
                    </div>

                    <div class="pt-2">
                        <button type="submit" class="w-full bg-blue-900 text-white py-3 px-6 rounded-lg hover:bg-blue-800 transition font-semibold flex items-center justify-center">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8 border border-blue-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex">
                                <input type="text" id="ticketNumber" name="ticketNumber" class="flex-grow px-4 py-2 border border-gray-300 rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan nomor tiket">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (complaintForm) {
            complaintForm.addEventListener('submit', async function(e) {
                ...
                form.querySelectorAll('input, textarea, select').forEach(el => el.classList.remove('border-red-600', 'shake-animation'));
                ...
                try {
                        ...
                        `,
                            ...
                            didOpen: () => {
                                document.getElementById('copy-ticket').addEventListener('click', () => {
                                    const ticketNumber = document.getElementById('ticket-number').innerText;
                                    navigator.clipboard.writeText(ticketNumber).then(() => {
                                        const copyButton = document.getElementById('copy-ticket');
                                        copyButton.innerText = 'Berhasil Disalin!';
                                        copyButton.classList.replace('bg-blue-600', 'bg-green-500');
                                        setTimeout(() => {
                                            copyButton.innerText = 'Salin Nomor Tiket';
                                            copyButton.classList.replace('bg-green-500', 'bg-blue-600');
                                        }, 2000);
                                    });
                                });
                            }
                    ...
                    submitButton.innerHTML = '<i data-feather="send" class="mr-2"></i> Kirim Pengaduan';
