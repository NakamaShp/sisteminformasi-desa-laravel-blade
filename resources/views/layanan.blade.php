            ...
            <div class="text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="service-card bg-gray-900 rounded-xl shadow-md overflow-hidden border border-gray-100 transition duration-300">
                    <div class="p-6">
                        ...
                        <p class="text-secondary-500 mb-4">Surat keterangan tempat tinggal untuk berbagai keperluan administrasi.</p>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-secondary-500"><i data-feather="clock" class="inline mr-1 w-4 h-4"></i> 1 Hari Kerja</span>
                            <button class="text-primary-500 font-medium hover:text-primary-700">Lihat Persyaratan →</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card bg-gray-900 rounded-xl shadow-md overflow-hidden border border-gray-100 transition duration-300">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-semibold text-primary-900">Kartu Keluarga</h3>
                        </div>
                        <p class="text-secondary-500 mb-4">Pendaftaran, perubahan data, dan penerbitan kartu keluarga.</p>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-secondary-500"><i data-feather="clock" class="inline mr-1 w-4 h-4"></i> 3 Hari Kerja</span>
                            <button class="text-primary-500 font-medium hover:text-primary-700">Lihat Persyaratan →</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card bg-gray-900 rounded-xl shadow-md overflow-hidden border border-gray-100 transition duration-300">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-semibold text-primary-900">Izin Mendirikan Bangunan</h3>
                        </div>
                        <p class="text-secondary-500 mb-4">Pengajuan izin pembangunan rumah atau bangunan lainnya.</p>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-secondary-500"><i data-feather="clock" class="inline mr-1 w-4 h-4"></i> 5 Hari Kerja</span>
                            <button class="text-primary-500 font-medium hover:text-primary-700">Lihat Persyaratan →</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card bg-gray-900 rounded-xl shadow-md overflow-hidden border border-gray-100 transition duration-300">
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-secondary-500"><i data-feather="clock" class="inline mr-1 w-4 h-4"></i> 2 Hari Kerja</span>
                            <button class="text-primary-500 font-medium hover:text-primary-700">Lihat Persyaratan →</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card bg-gray-900 rounded-xl shadow-md overflow-hidden border border-gray-100 transition duration-300">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-semibold text-primary-900">Akta Kelahiran</h3>
                        </div>
                ...
                <div class="service-card bg-gray-900 rounded-xl shadow-md overflow-hidden border border-gray-100 transition duration-300">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-semibold text-primary-900">Layanan Lainnya</h3>
                        </div>
                        <p class="text-secondary-500 mb-4">Temukan berbagai layanan administrasi lainnya yang tersedia.</p>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-secondary-500"><i data-feather="info" class="inline mr-1 w-4 h-4"></i> Variatif</span>
                            <button class="text-primary-500 font-medium hover:text-primary-700">Lihat Semua →</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex flex-col md:flex-row items-stretch gap-8">
            ...
            <div class="md:w-1/2 mb-8 md:mb-0">
                <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200 h-full">
                    ...
                    <button class="mt-8 bg-primary-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-600 transition">
